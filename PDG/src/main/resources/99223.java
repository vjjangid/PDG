...
public class Acr2Dcm {
    ...
    private DcmEncodeParam encodeParam() {
        return new DcmEncodeParam(ByteOrder.LITTLE_ENDIAN, false, false, false, skipGroupLen, undefSeqLen, undefItemLen);
    }
    ...
    public int mconvert(String[] args, int optind, File destDir) throws IOException {
        int count = 0;
